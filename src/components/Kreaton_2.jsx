...
Command: npx gltfjsx@6.5.3 ./public/Kreaton_2.glb --transform 
Files: ./public/Kreaton_2.glb [10.83MB] > /Users/slim-cd/Documents/_Projects/__Creative Directors Website/website 2025/react-3D/cd25_website/Kreaton_2-transformed.glb [720.54KB] (93%)
*/
...
const Kreaton = forwardRef((props, ref) => {
  ...
  const { scene, animations } = useGLTF("src/models/Kreaton_2-transformed.glb");
  ...
  useEffect(() => {
    ...
    console.log("nodes.Armsmesh_2 :", nodes.mixamorigHips);
    ...
    <group ref={internalRef} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Arms001">
          ...
          >
            <NodeToyMaterial
              url={"https://draft.nodetoy.co/MpXrEk3U6lIBuEzy"}
            />
          </skinnedMesh>
        </group>
...
useGLTF.preload("src/models/Kreaton_2-transformed.glb");
